...
def main():
    ...
    parser.add_argument(
        "--file", type=str, required=True, help="Path to the requirements file"
    )

    parser.add_argument(
        "--description", type=str, required=True, help="Domain description"
    )
    ...
    parser.add_argument(
        "--model", type=str, default="gpt-4.1-mini", help="LLM model name"
    )
