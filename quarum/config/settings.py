...
class Settings:
    ...
    DEFAULT_SETTINGS = {
        ...
        "document": {
            ...
            "chunk_overlap": 200,
            "max_chunk_count": 100,
            "section_headers": ["# ", "## ", "### ", "Chapter ", "Section "],
        },
        # Model generation
        "model": {
            "max_entities": 50,
    ...
    def load_from_file(self, config_path: str) -> bool:
        ...
        try:
            ...
            logger.warning("Failed to load settings from %s: %s", config_path, str(e))
            return False
    ...
    def _load_from_env(self) -> None:
        ...
        for key, value in os.environ.items():
            if key.startswith(prefix):
                ...
                logger.debug("Setting %s from environment variable", key)
    ...
    def save_to_file(self, config_path: str) -> bool:
        ...
        try:
            ...
            logger.warning("Failed to save settings to %s : %s", config_path, str(e))
            return False
    ...
    def reset_section(self, section: str) -> bool:
        ...
        if section in self.DEFAULT_SETTINGS:
            ...
            logger.info("Reset %s settings to defaults", section)
            return True
        else:
            logger.warning("Section %s not found in default settings", section)
            return False
